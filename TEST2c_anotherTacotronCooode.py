...
# TODOOOOO:
# audio.inv_linear_spectrogram
# something like this from https://github.com/cnlinxi/tacotron2decoder/blob/b042de19f9bcd8e8936748a6200c3c5bf3286913/tacotron/synthesizer.py#L222

# linear / mel ???
# ENCODE: linearspectrogram(wav, hparams):
# DECODE: inv_linear_spectrogram(linear_spectrogram, hparams)
